    ...
    <>
      <section className="tw-container tw-mt-10 ">
        <div className="tw-text-center">
          ...
          <button className="tw-bg-white tw-text-black tw-border-2 tw-border-solid hover:tw-border-black  tw-rounded-full tw-py-3 tw-px-5 hover:tw-scale-105 tw-transition-all tw-mt-4 tw-mx-2">
            Recommended
          </button>
          <button className="tw-bg-white tw-text-black tw-border-2 tw-border-solid hover:tw-border-black  tw-rounded-full tw-py-3 tw-px-5 hover:tw-scale-105 tw-transition-all tw-mt-4 tw-mx-2">
        ...
        <div className="tw-container new">
          <div className="tw-flex tw-mx-20 tw-my-5 Nest-Hub">
            ...
            <div className="tw-relative tw-left-0 main-Flex tw-m-6">
              <div className="bg-img1 tw-px-20 Flex-2  tw-relative">
                <div className="tw-relative tw-top-12 -tw-left-14">
                  ...
                  <h1 className="tw-font-semibold tw-my-4">
                    Ensure your company and website <br /> stand out with a .co
                    domain. 3-year <br /> purchase required. Additional <br />{" "}
                    year(s) $ 47.99.
                  </h1>
                  <button className="tw-bg-black tw-text-white tw-font-semibold tw-py-3 tw-px-3 tw-rounded-lg tw-mb-7">
                    Search Domains
              ...
              <div className="bg-img2 tw-p-8 Flex-3 tw-relative">
                <div className="">
                  ...
                  <h1 className="tw-font-semibold tw-my-4">
                    Boost your local impact with our <br /> localized top-level
                    domains.
                  </h1>
                  <button className="tw-bg-black tw-text-white tw-font-semibold tw-py-3 tw-px-3 tw-rounded-lg tw-mb-7">
                    Search Domains
          ...
          <div className="tw-container tw-px-5 tw-py-24 tw-mx-auto tw-flex tw-flex-wrap Tablate">
            <div className="lg:tw-w-2/3 tw-mx-auto">
              <div className="tw-flex tw-flex-wrap tw-w-full tw-py-32 tw-px-10 tw-relative tw-mb-4 Tablate-div">
                <img
                  alt="gallery"
                  className="tw-w-full tw-object-cover tw-h-full tw-object-center tw-block tw-absolute tw-inset-0 tw-rounded-3xl"
                  src={tabImg}
                />
              ...
              <div className="tw-flex tw-flex-wrap -tw-mx-2">
                <div className="tw-px-2 tw-w-1/2" id="hidden1">
                  <div className="tw-flex tw-flex-wrap tw-w-full sm:tw-py-24 tw-py-16 sm:tw-px-10 tw-px-6 tw-relative">
                    <img
                      alt="gallery"
                      className="tw-w-full tw-object-cover tw-h-full tw-object-center tw-block tw-rounded-3xl tw-absolute tw-inset-0"
                      src={tabImg1}
                    />
